...
const ReviewerAction = () => {
  return (
    <section className='w-full mb-12'>
      <div
        className='flex justify-items-center w-full container'
      >
        <Dialog>
          <DialogTrigger asChild>
            ...
            >
              <div
                className='relative mx-auto w-full lg:h-[480px] hover:cursor-pointer hover:scale-[101%] transition-all duration-200 rounded-[4px] overflow-hidden'
              >
                <LoadingImage
                ...
                <LoadingImage
                  ...
                  alt='Reviewer Action'
                  fill
                  className='absolute object-cover hidden lg:block w-auto h-auto'
          ...
          <DialogContent className="w-full max-w-5xl h-auto p-0 border-black rounded-md overflow-hidden">
